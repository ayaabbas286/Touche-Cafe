...
// بيانات الصور (استبدل الروابط بصورك الحقيقية)
  allImages: GalleryImage[] = [
    ...
    { id: 2, url: 'assets/Gallery/4.jpg', category: 'food', alt: 'Signature Burger' },
    { id: 3, url: 'assets/Gallery/6.jpg', category: 'events', alt: 'Live Jazz Band' },
    { id: 4, url: 'assets/Gallery/2.jpg', category: 'food', alt: 'Espresso Art' },
    { id: 5, url: 'assets/Gallery/3.jpg', category: 'interior', alt: 'Cozy Corner' },
    { id: 6, url: 'assets/Gallery/5.jpg', category: 'food', alt: 'Pancakes' },
    { id: 7, url: 'assets/Gallery/8.jpg', category: 'events', alt: 'Private Party' },
    { id: 8, url: 'assets/Gallery/7.jpg', category: 'interior', alt: 'Outdoor Seating' },
  ];
